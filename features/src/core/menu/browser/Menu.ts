...
mainMenu.push(
  ...
  },
  {
    ...
    path: 'customers',
    component: lazy(
      () => import('../../../sales/customers/browser/CustomerScene')
    ),
    ...
    items: [
      {
        ...
        path: 'orders',
        component: lazy(
          () => import('../../../sales/sales-orders/browser/SalesOrderScene')
        ),
        scopes: [
          SecurityScopes.salesOrdersList,
          SecurityScopes.manageSalesOrders,
        ],
      },
      {
    ...
    items: [
      {
        ...
        path: 'wms',
        component: lazy(() => import('../../layout/browser/WmsGrid')),
      },
      {
        title: 'WMS Standard',
        icon: 'BarChartOutlined',
        path: 'wms-standard',
        component: lazy(() => import('../../../sales/wms/browser/WmsScene')),
      },
    ],
  },
  undefined,
